...
public class NewSwipeRefreshLayoutUtil {
    // Header View
//    private ProgressBar progressBar;
     ...
     * @param listener
     */
    public void setSwipeRefreshView(final NewSwipeRefreshLayout swipeRefreshLayout, final OnRefreshAndLoadMoreListener listener) {
        ...
        swipeRefreshLayout.setOnPullRefreshListener(new NewSwipeRefreshLayout.OnPullRefreshListener() {
            @Override
...
//                        progressBar.setVisibility(View.GONE);
        ...
        swipeRefreshLayout.setOnPushLoadMoreListener(new NewSwipeRefreshLayout.OnPushLoadMoreListener() {
...
//                            swipeRefreshLayout.setLoadMore(false);
    ...
    public View createFooterView(NewSwipeRefreshLayout swipeRefreshLayout) {
    ...
    public View createHeaderView(NewSwipeRefreshLayout swipeRefreshLayout) {
