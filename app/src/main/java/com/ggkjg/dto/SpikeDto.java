...
public class SpikeDto implements Serializable {
    ...
    public List<SpikeDto> sedKillTimes;

    public List<SpikeDto> records;
   ...
   public String isNew;
   public String isHot;
   public String appraiseRate;
   public String isSpec;
   public String isColor;
   public String appraiseJakeTotal;
   ...
   public String discount;
    ...
    public String storeShoppingOrderDetailList;
