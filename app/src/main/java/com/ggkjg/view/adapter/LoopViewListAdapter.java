 ...
 */
public class LoopViewListAdapter extends BaseLoopPagerAdapter {

    private final List<BusinessListDto> bannerDtoList;
    ...
    public LoopViewListAdapter(Activity activity, ViewPager viewPager, ViewGroup indicators) {
        super(viewPager);
    ...
    public void setList(List<BusinessListDto> heroes) {
        bannerDtoList.clear();
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        final BusinessListDto slidersDto = bannerDtoList.get(position);
