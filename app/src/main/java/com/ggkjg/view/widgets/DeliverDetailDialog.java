 ...
 */
public class DeliverDetailDialog extends Dialog {
    private Context mContext;
    @BindView(R.id.iv_dialog_deliver_detail_submit)
    Button butSubmit;
    @BindView(R.id.iv_dialog_deliver_detail_clean)
    ImageView clean;



    public DeliverDetailDialog(Context context) {
        super(context, R.style.dialog_with_alpha);
//        setCanceledOnTouchOutside(false);//设置点击外部不可以取消;
        this.mContext = context;
        setContentView(R.layout.dialog_deliver_detail);
