...
public class SuperSwipeRefreshLayout extends ViewGroup {
    ...
    private static final int HEADER_VIEW_HEIGHT = 95;// HeaderView height (dp)
    private static final int FOOTER_VIEW_HEIGHT = 72;// HeaderView height (dp)
    ...
    private static final int DEFAULT_CIRCLE_TARGET = 95;
    ...
    private boolean isEnablePull = true;//是否支持下拉
    private boolean isEnableLoadMore = true;//是否支持上拉
...
//                    Log.d(LOG_TAG,"Got ACTION_MOVE event but don't have an active pointer id.");
                    return false;
                }
