package com.ggkjg.db;

import android.content.Context;

import com.ggkjg.db.greendao.gen.DaoMaster;
import com.ggkjg.db.greendao.gen.DaoSession;
...
public class DaoManager {
    private static final String DB_NAME = "yikeshu_greendao";
